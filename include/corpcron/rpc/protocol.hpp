...
constexpr uint32_t kHealthCheckRequestSerialId = 25;
constexpr uint32_t kHealthCheckResponseSerialId = 26;
constexpr uint32_t kStreamMetricsRequestSerialId = 27;
constexpr uint32_t kStreamMetricsResponseSerialId = 28;
